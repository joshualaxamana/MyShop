<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Admin_Products_Add" %>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <asp:TextBox ID="txtPrice" runat="server"
                        ...
                        min="1.00" max="10000.00" step="0.01" required />
                </div>
            </div>
            <div class="form-group">
